...
module Home = {
  ...
  let firstParagraphHeader =
    @intl.description("Header of the first paragraph on the home page")
    {id: "115ab101-90af-43cc-ad43-2ffe55cf8e3f", defaultMessage: "Reklama"}
  let firstParagraph =
  ...
  let thirdParagraphHeader =
    ...
    {id: "7f0e21bf-8a5a-4d99-b522-2fc5ad383b4e", defaultMessage: "Dabing"}
  let thirdParagraph =
...
module News = {
  ...
  let header =
    @intl.description("News page - the header")
    {id: "ae88fbab-0433-4390-93b1-2048cc540f42", defaultMessage: "Aktuální info"}
}
...
module Contact = {
  ...
  let registrationDatabaseTitle =
    @intl.description("Contact bottom bar - the Registration, database title")
    {
  ...
  let castingsInfo =
    @intl.description("Contact bottom bar - castings info")
    {
